...
def generate_launch_description():
    ...
    # Gazebo simulation - usar archivo local de forma portable
    # pkg_share está en install/turtlebot3_slam_mapper/share/turtlebot3_slam_mapper/
    # Necesitamos subir 4 niveles para llegar a la raíz del workspace
    current_workspace = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(pkg_share))))
    gazebo_launch_file = os.path.join(current_workspace, 'archivos', 'turtlebot3_maze.launch.py')
